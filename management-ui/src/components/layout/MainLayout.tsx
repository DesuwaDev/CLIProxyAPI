import { nativeNavigation } from '@/features/nativeManagement/registry';
import { useNativeManagement } from '@/features/nativeManagement/context';
import {
  ReactNode,
  RefObject,
  SVGProps,
...
export function MainLayout() {
  ...
  const navGroups: SidebarNavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...nativeNavigation
          .filter((item) => native.enabled(item.module) || (item.module === 'risk' && !!native.status))
          .map((item) => ({
            path: item.path,
