import { KeyUsageBadge } from '@/features/nativeManagement/InventorySummary';
  ...
  return (
    <div className="form-group" style={{ marginBottom: 0 }}>
      ...
      >
        ...
        {modalOpen && (
          <CredentialControls scope="client" target={inputValue.trim()} disabled={disabled} />
        )}
      </Modal>
    </div>
  );
