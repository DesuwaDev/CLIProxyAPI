import { AccountUsageSummary } from '@/features/nativeManagement/InventorySummary';
...
export type AuthFileCardProps = {
  ...
  /** A null delay disables the initial entry animation. */
...
export function AuthFileCard(props: AuthFileCardProps) {
  ...
  // Capture the entry delay once so later parent updates do not restart animation.
  ...
  return (
    <article className={cardClasses} style={cardStyle}>
      ...
      <AccountUsageSummary target={authIndexKey || undefined} fileName={file.name} />
